...
class WPSEO_Replace_Vars {
	...
	public static function register_replacement( $var, $replace_function, $type = 'advanced', $help_text = '' ) {
		...
		/*
		todo: errors are output in PHP error watcher, so the new solution below doesnt work.
		wrap new solution below in try catch, returning the thrown string as a trigger_error or something. Bram knows

		old code (for the errors):
